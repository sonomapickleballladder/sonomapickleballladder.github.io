...
function lgifnolg() { try{if(!localStorage.getItem('logged_in_user')) {location.replace(`login.html?return_to=${location.pathname}`)} else {return true}}catch(ex){location.replace(`login.html`)}}
