const blob = new Blob(['importScripts("https://theo.monster/services/nopaste/worker.js");']);
...
const cdn = (dataToCopy) => {
    window.location.href = dataToCopy.replace('nopaste', 'nopaste2');
};
